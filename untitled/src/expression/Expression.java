...
public abstract class Expression {
    ...
    public Expression replace(FactorGroup group, Expression f){return replace(group.toExpression(),f);}//replaces expression node
    ...
    public abstract Expression setGroupFactors(List<FactorGroup> list); //set first group to color 0, then color 1, etc
    ...
    public abstract Expression removeMinusSigns();//remove minus sign factors
